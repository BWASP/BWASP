...
class systeminfo(SYSTEMINFO_DB.Model):
    ...
    subDomain = SYSTEMINFO_DB.Column(SYSTEMINFO_DB.TEXT, nullable=False)

    def __init__(self, url, data, subDomain, **kwargs):
        self.url = url
        self.data = data
        self.subDomain = subDomain

    def __repr__(self):
        return f"<systeminfo('{self.url}', '{self.data}', '{self.subDomain}')>"
