...
from .attack_vector import ns as attackVectorNamespace
from .csp_evaluator import ns as cspEvaluatorNamespace
from .cve_info import ns as cveInfoNamespace
from .domain import ns as domainNamespace
from .job import ns as jobNamespace
from .packet import ns as packetNamespace
...
api.add_namespace(attackVectorNamespace)
