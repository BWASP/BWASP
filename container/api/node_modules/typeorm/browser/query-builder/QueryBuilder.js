    ...
    getWherePredicateCondition(aliasPath, parameterValue) {
        if (InstanceChecker.isFindOperator(parameterValue)) {
            ...
            if (nullBehavior === "sql-null") {
                ...
                throw new TypeORMError(`Null value encountered in property '${aliasPath}' of a where condition. ` +
            ...
            if (undefinedBehavior === "throw") {
                throw new TypeORMError(`Undefined value encountered in property '${aliasPath}' of a where condition. ` +
